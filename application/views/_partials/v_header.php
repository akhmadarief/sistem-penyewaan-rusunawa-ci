                ...
                <ul class="nav navbar-toolbar">
                    <li class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" style="min-width: 150px">
                            <a class="dropdown-item" href="<?php echo base_url("ubah_pass") ?>"><i class="fa fa-lock"></i>Ubah Password</a>
                            <a class="dropdown-item" href="<?php echo base_url("tambah_user") ?>" <?php if ($username != 'admin') echo 'style="display: none"' ?>><i class="fa fa-user"></i>Tambah User</a>
