                            ...
                            <form class="form-horizontal" action="<?php echo base_url('aksi/aksi_edit_penghuni') ?>" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control select2_fakultas" name="id_fakultas" id="fakultas" required>
                                            <option></option>
                                            <?php foreach ($fakultas1 as $fakultas1){ ?>
                                            <option value="<?php echo $fakultas1->id_fakultas ?>" <?php if ($fakultas1->id_fakultas == $penghuni->id_fakultas) echo 'selected' ?>><?php echo $fakultas1->nama_fakultas ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control select2_prodi" name="id_prodi" id="prodi" required>
                                            ...
                                            <option value="<?php echo $prodi1->id_prodi ?>" <?php if ($prodi1->id_prodi == $penghuni->id_prodi) echo 'selected' ?>><?php echo $prodi1->nama_prodi ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
