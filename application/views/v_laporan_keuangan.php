                ...
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Laporan Keuangan<?php //echo $halaman ?></div>
                            <a class="btn btn-success btn-xls" href="<?php echo base_url('admin/laporan_keuangan_cetak'); ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Cetak Daftar Piutang"> XLS
                        ...
                        <table class="table table-striped table-bordered table-hover" id="tabel-penghuni" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo $keuangan->piutang == 0 ? '<span class="badge badge-success">Sudah Lunas</span>' : 'Rp'.number_format($keuangan->piutang, 0, ',', '.') ?>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
